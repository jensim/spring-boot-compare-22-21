...
public class MyController22 {
    ...
    public void getter(
            ...
            @RequestParam(required = true) SortOrder22 foo02,
            ...
            @RequestParam(required = true) SortOrder22 foo07,
            ...
            @RequestParam(required = false, defaultValue = "DES,ASC,FAR") List<SortOrder22> foo10,
            @Schema(description = "foo11 description", example = "DES,ASC,FAR")
            @RequestParam(required = true) List<SortOrder22> foo11,
            @Schema(description = "foo12 description", example = "ASC")
            @RequestParam(required = true) SortOrder22 foo12,
            ...
            @RequestParam(required = true) SortOrder22 foo17,
            ...
            @RequestParam(required = false, defaultValue = "DES,ASC,FAR") List<SortOrder22> foo20,
            @Schema(description = "foo21 description", example = "DES,ASC,FAR")
            @RequestParam(required = true) List<SortOrder22> foo21
    ) {
        ...
        public void getterWithDefaults(
                ...
                @Schema(description = "foo02 description", example = "ASC")
                @RequestParam(required = false, defaultValue = "FAR") SortOrder22 foo02,
                @Schema(description = "foo03 description", example = "3")
                ...
                @Schema(description = "foo07 description", example = "DES")
                @RequestParam(required = false, defaultValue = "DES") SortOrder22 foo07,
                @Schema(description = "foo08 description", example = "foo08")
                ...
                @RequestParam(required = false, defaultValue = "DES,ASC,FAR") List<SortOrder22> foo10,
                @Schema(description = "foo11 description", example = "DES,ASC,FAR")
                @RequestParam(required = false, defaultValue = "DES,ASC,FAR") List<SortOrder22> foo11,
                @Schema(description = "foo12 description", example = "ASC")
                @RequestParam(required = false, defaultValue = "ASC") SortOrder22 foo12,
                @Schema(description = "foo13 description", example = "3")
                ...
                @Schema(description = "foo17 description", example = "DES")
                @RequestParam(required = false, defaultValue = "DES") SortOrder22 foo17,
                @Schema(description = "foo18 description", example = "foo18")
                ...
                @RequestParam(required = false, defaultValue = "DES,ASC,FAR") List<SortOrder22> foo20,
                @Schema(description = "foo21 description", example = "DES,ASC,FAR")
                @RequestParam(required = false, defaultValue = "DES,VER") List<SortOrder22> foo21
        ) {
                Objects.requireNonNull(foo01);
                Objects.requireNonNull(foo02);
                Objects.requireNonNull(foo03);
