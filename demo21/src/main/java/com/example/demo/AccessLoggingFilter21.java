...
@Component
public class AccessLoggingFilter21 extends OncePerRequestFilter {

    private static final Logger logger = LoggerFactory.getLogger(AccessLoggingFilter21.class);

    public AccessLoggingFilter21() {
